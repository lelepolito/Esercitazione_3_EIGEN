...
x2 = Palu(A2, B2);   
x3 = Palu(A3, B3);
    cout << "Questi sono gli errori relativi rispetto a A1,A2,A3 con Palu" << endl << endl;
...
cout << "Questi sono gli errori relativi rispetto a A1,A2,A3 con QR" << endl << endl;
x1 = QR(A1, B1);
x2 = QR(A2, B2);
x3 = QR(A3, B3);
cout << "Errore di A1 : " << ErroreRelativo(x1,x) << endl << endl;
